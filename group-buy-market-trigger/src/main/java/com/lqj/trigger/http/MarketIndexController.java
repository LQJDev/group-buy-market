...
import com.lqj.api.IMarketIndexService;
 ...
 * @Author 李岐鉴
 * @Date 2025/12/13
 * @Description MarketIndexController 类
 */
@Slf4j
@RestController()
@CrossOrigin("*")
...
public class MarketIndexController implements IMarketIndexService {
    ...
    @RateLimiterAccessInterceptor(key = "userId", fallbackMethod = "queryGroupBuyMarketConfigFallBack", permitsPerSecond = 0.1d, blacklistCount = 1)
